...
st.title("Arbre existentiel probabiliste — V2")
st.caption("Le moteur conserve les 6 561 feuilles, mais l’interface restitue une trajectoire lisible.")
...
with st.expander("Méthode"):
    ...
    - sortie → profil, tensions, scénarios, bifurcations, leviers
